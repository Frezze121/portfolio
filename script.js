...
function randomcolor(){
  ...
  document.getElementById("skill-test1").style.background="#2be23154"
  document.getElementById("skill-test2").style.background="#5f9ea05c"
  document.getElementById("skill-test3").style.background="#faebd773"
  document.getElementById("skill-test4").style.background="#0000ff47"
  document.getElementById("skill-test6").style.background="#a52a2a6b"
  document.getElementById("skill-test7").style.background="#ffe4c461"
  document.getElementById("skill-test8").style.background="#8a2be259"
  document.getElementById("skill-test9").style.background="#00ffff75"
}

function original_colors() {
  document.getElementById("skill-html").style.background="linear-gradient(45deg, #cf73fbd4, #3d05abb8)"
  document.getElementById("skill-js").style.background="linear-gradient(45deg, #ffbb73e6, #d94600d4)"
  document.getElementById("skill-css").style.background="linear-gradient(45deg, #009343c4, #3b96f3e0)"
  document.getElementById("skill-python").style.background="linear-gradient(45deg, #e14545e0, #5b0000ed)"
  document.getElementById("skill-wordpress").style.background="linear-gradient(45deg, #370034b3, #e3009399)"
  document.getElementById("skill-mc").style.background="linear-gradient(45deg, #35d143, #014500)"
  document.getElementById("skill-mysql").style.background="linear-gradient(45deg, #ffec5adb, #833f05e0)"
  document.getElementById("skill-adobe").style.background="linear-gradient(45deg, #68d9a1d6, #011039d6)"

  document.getElementById("skill-test1").style.background="#00ffff75"
  document.getElementById("skill-test2").style.background="#faebd773"
  document.getElementById("skill-test3").style.background="#ffe4c461"
  document.getElementById("skill-test4").style.background="#a52a2a6b"
  document.getElementById("skill-test6").style.background="#0000ff47"
  document.getElementById("skill-test7").style.background="#2be23154"
  document.getElementById("skill-test8").style.background="#5f9ea05c"
  document.getElementById("skill-test9").style.background="#8a2be254"
}
